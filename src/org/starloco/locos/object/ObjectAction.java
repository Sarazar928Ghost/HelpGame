                ...
                switch (Integer.parseInt(type)) {
                    ...
                    case 22://Poser un prisme.
                        ...
                        if (!player.is_showWings()) {
                            SocketManager.GAME_SEND_MESSAGE(player, "Vos ailes doivent ̻tre activer afin de poser un prisme.");
                            return;
                        }
                        ...
                        if (subArea.getAlignement() != 0 || !subArea.getConquistable()) {
                            SocketManager.GAME_SEND_MESSAGE(player, "L'alignement de cette sous-zone est en conqu̻te ou n'est pas neutre !");
                            return;
                        }
