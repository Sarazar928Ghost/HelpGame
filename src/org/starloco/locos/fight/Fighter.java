...
//                        + this.mob.getPa();
    ...
    public int getPros() {
        switch (this.type) {
            ...
            case 2: // mob
                if (this.isInvocation()) // Si c'est un coffre animï¿½, la chance est ï¿½gale ï¿½ 1000*(1+lvlinvocateur/100)
    ...
    public String getGmPacket(char c, boolean withGm) {
        ...
        switch (this.type) {
            ...
            case 5://Perco
                ...
                str.append("1;");
                str.append("2;4;");
                str.append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";").append((int) Math.floor(G.getLvl() / 2)).append(";");//Rï¿½sistances
                str.append(this.team);
                break;
            case 7://Prisme
                str.append("-2;");
